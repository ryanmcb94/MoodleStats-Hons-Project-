...
public interface IHonsService
{
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/LoginMoodle", ReplyAction="http://tempuri.org/IHonsService/LoginMoodleResponse")]
    ...
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsYear", ReplyAction="http://tempuri.org/IHonsService/getAvgsYearResponse")]
    int[] getAvgsYear(int ID);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsYear", ReplyAction="http://tempuri.org/IHonsService/getAvgsYearResponse")]
    System.Threading.Tasks.Task<int[]> getAvgsYearAsync(int ID);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsMonth", ReplyAction="http://tempuri.org/IHonsService/getAvgsMonthResponse")]
    int[] getAvgsMonth(int ID);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsMonth", ReplyAction="http://tempuri.org/IHonsService/getAvgsMonthResponse")]
    System.Threading.Tasks.Task<int[]> getAvgsMonthAsync(int ID);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsWeek", ReplyAction="http://tempuri.org/IHonsService/getAvgsWeekResponse")]
    int[] getAvgsWeek(int ID);
    
    [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IHonsService/getAvgsWeek", ReplyAction="http://tempuri.org/IHonsService/getAvgsWeekResponse")]
    System.Threading.Tasks.Task<int[]> getAvgsWeekAsync(int ID);
...
public partial class HonsServiceClient : System.ServiceModel.ClientBase<IHonsService>, IHonsService
{
    ...
    public int[] getAvgsYear(int ID)
    {
        return base.Channel.getAvgsYear(ID);
    }
    
    public System.Threading.Tasks.Task<int[]> getAvgsYearAsync(int ID)
    {
        return base.Channel.getAvgsYearAsync(ID);
    }
    
    public int[] getAvgsMonth(int ID)
    {
        return base.Channel.getAvgsMonth(ID);
    }
    
    public System.Threading.Tasks.Task<int[]> getAvgsMonthAsync(int ID)
    {
        return base.Channel.getAvgsMonthAsync(ID);
    }
    
    public int[] getAvgsWeek(int ID)
    {
        return base.Channel.getAvgsWeek(ID);
    }
    
    public System.Threading.Tasks.Task<int[]> getAvgsWeekAsync(int ID)
    {
